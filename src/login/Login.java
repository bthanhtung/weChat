...
public class Login {
	...
	private void initialize() {
		...
		JLabel lblWelcome = new JLabel("K\u1EBFt n\u1ED1i v\u1EDBi m\u00E1y ch\u1EE7");
		...
		JLabel lblHostServer = new JLabel("\u0110\u1ECBa ch\u1EC9 m\u00E1y ch\u1EE7");
		lblHostServer.setFont(new Font("Segoe UI", Font.PLAIN, 13));
		lblHostServer.setBounds(10, 72, 123, 26);
		frameLoginForm.getContentPane().add(lblHostServer);

		JLabel lblPortServer = new JLabel("C\u1ED5ng k\u1EBFt n\u1ED1i");
		lblPortServer.setFont(new Font("Segoe UI", Font.PLAIN, 13));
		lblPortServer.setBounds(349, 72, 79, 26);
		...
		txtPort.setBounds(429, 72, 65, 26);
		frameLoginForm.getContentPane().add(txtPort);

		JLabel lblUserName = new JLabel("T\u00EAn \u0111\u0103ng nh\u1EADp");
		lblUserName.setFont(new Font("Segoe UI", Font.PLAIN, 13));
		lblUserName.setBounds(10, 134, 129, 38);
		...
		txtUsername.setBounds(143, 134, 351, 38);
		...
		btnLogin.setBounds(170, 216, 169, 63);

...
public class ServerGui {
	...
	private void initialize() {
		...
		frmServerMangement.setTitle("Qu\u1EA3n l\u00FD m\u00E1y ch\u1EE7");
...
//		ImageIcon imageIcon = new ImageIcon(dimg);
		...
		lblNhom.setBounds(242, 11, 268, 76);
		...
		lblStatus.setBounds(147, 168, 98, 16);
		...
		JLabel lbllabelUserOnline = new JLabel("Ng\u01B0\u1EDDi k\u1EBFt n\u1ED1i");
		...
		lblUserOnline.setBounds(147, 207, 56, 16);
